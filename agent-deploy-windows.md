...
2. Obtain the ingestion URL for your instance. For more information, see [Collector endpoints](/docs/workload-protection?topic=workload-protection-supported-endpoints#supported-endpoints-collector).
...
4. Complete the following fields:
   ...
   Custom Collector
   :   The ingestion URL for the region where your {{site.data.keyword.sysdigsecure_short}} instance is available. For more information, see [Collector endpoints](/docs/workload-protection?topic=workload-protection-supported-endpoints#supported-endpoints-collector). For example, `ingest.private.us-east.security-compliance-secure.cloud.ibm.com`.

   Custom Collector port
   :   The collector port. Set to `6443`.

   Custom API URL
   :   The API endpoint URL for the region where your {{site.data.keyword.sysdigsecure_short}} instance is available. For more information, see [API endpoints](/docs/workload-protection?topic=workload-protection-supported-endpoints#supported-endpoints-rest-api). For example, `https://private.us-east.security-compliance-secure.cloud.ibm.com`.
