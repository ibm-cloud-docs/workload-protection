...
Check out [Windows Threat Detection with {{site.data.keyword.sysdigsecure_full_notm}}](https://community.ibm.com/community/user/blogs/victor-guerrero/2024/01/11/windows-threat-detection-with-ibm-security-and-com?CommunityKey=dd1ee2bc-c83b-4afb-bd1c-9095ff0c3bc1){: external} to see examples of threat detection on Windows and how to troubleshoot detected events.
