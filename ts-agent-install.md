...
5. Confirm that outbound TCP traffic to the collector endpoint on port 6443 is allowed. For a list of collector endpoints, see [Collector endpoints](/docs/workload-protection?topic=workload-protection-supported-endpoints#supported-endpoints-collector).
