...
The following posture policies are available for implementing CSPM for your {{site.data.keyword.cloud_notm}} resources. These policies help you validate compliance with industry standards, regulatory requirements, and security best practices.
...
| {{site.data.keyword.cloud_notm}} Sovereignty Assessment | {{site.data.keyword.cloud_notm}} Sovereignty Assessment evaluates the controls necessary to maintain digital sovereignty across {{site.data.keyword.cloud_notm}} environments. It addresses extraterritorial access, operational control, data residency and replication, foreign administration, hyperscaler concentration risk, integrity of regulated data, cryptographic posture (including post-quantum exposure), regulatory demonstrability, sovereign resilience, and oversight of AI-driven decision systems. |
...
Posture policies for other environments such as AWS, Azure, GCP, Kubernetes, OpenShift, or hosts are also available.
{: note}

## List of services supported by {{site.data.keyword.sysdigsecure_short}}
{: #about-available-services}

{{site.data.keyword.sysdigsecure_full}} supports the following {{site.data.keyword.cloud_notm}} services:

### Compute
{: #supported-services-compute}
...
- [IBM Cloud Backup for VPC](/docs/vpc?topic=vpc-backup-service-about)

### Networking
{: #supported-services-networking}
...
- [Network ACL for VPC](/docs/vpc?topic=vpc-using-acls)
...
- [Flow Logs for VPC](/docs/vpc?topic=vpc-flow-logs)
- [DNS Service for VPC](/docs/dns-svcs)
...
- [IBM Cloudant](/docs/Cloudant-cli-plugin)
...
{: #supported-services-integration}
...
### Observability
{: #supported-services-observability}
...
{: #supported-services-ai}

- [watsonx.ai Runtime](https://dataplatform.cloud.ibm.com/docs/content/wsj/analyze-data/ml-overview.html?context=cpdaas){: external}
