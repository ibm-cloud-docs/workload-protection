...
6. For Classic Infrastructure resources, ensure that the agent is deployed with the correct collector endpoint for your region. See [Endpoints](/docs/workload-protection?topic=workload-protection-supported-endpoints) for the correct values.
